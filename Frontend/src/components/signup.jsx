    ...
    return (
        <div className="Signup--container flex items-center justify-center h-[100vh] w-fit mx-auto sm:w-full">
            ...
            >
                ...
                <Input placeholder={'Enter Your Phone Number'} id={'phone--number'} name={'tel'} type={'tel'} />
                <InputPassword placeholder={'Enter Your Password'} id={'password'} name={'password'} type={'password'} />
                <InputPassword placeholder={'Confirm Your Password'} id={'confirm--password'} name={'confirmPassword'} type={'password'} />
